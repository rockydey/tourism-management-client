...
const SpotCard = ({ spot }) => {
  ...
  return (
    <div className='card dark:bg-color1 lg:card-side bg-base-100 shadow-xl'>
      <figure>
        <img className='w-full lg:h-full md:rounded-s-xl' src={image} alt='' />
      </figure>
      <div className='card-body font-gothic'>
        <h3 className='text-xl font-bold text-color6'>
          {tourists_spot_name}, {location}
        </h3>
        <h3 className='text-lg font-bold text-color6'>{country_Name}</h3>
