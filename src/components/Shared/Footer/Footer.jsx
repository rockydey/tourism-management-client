...
const Footer = () => {
  return (
    <div className=''>
            ...
            <div className='space-y-5'>
              ...
              <div className='text-xl flex gap-3 text-color6'>
                <div>
                  <p
                    id='facebook'
                    className='flex cursor-pointer p-2 rounded-md dark:bg-color7 dark:text-color8'>
                    <FaFacebook />
                  </p>
                ...
                <div>
                  ...
                  <Tooltip anchorSelect='#twitter' place='bottom'>
                    Twitter
                  </Tooltip>
                </div>
                <div>
                  ...
                  <Tooltip anchorSelect='#pinterest' place='bottom'>
                    Pinterest
                  </Tooltip>
                </div>
              </div>
      ...
      <div className='dark:bg-color6 bg-color1 border-t-2 border-color8 dark:border-color7 py-5'>
